...
<li id="back" class="no-sp"><a href="/pmproducts" class="disp_f">カテゴリトップに戻る</a></li>
...
<li class="text_c">
<a href="/pm-contact?goods_title=<?php the_title();?>&goods_code=<?php the_field('code');?>" class="disp_f">お問い合わせ</a>
</li>
</ul>
</nav>
</div>
...
<span class="price"><span class="num"><?php echo number_format((int)get_field('price')); ?></span><span class="yen">円（税抜）</span></span>
</div>
...
<dd class="product_detail_content"><?php $term = get_field('class'); echo $term->name; ?></dd>
...
<dd class="product_detail_content"><?php the_field('spec'); ?></dd>
...
<a href="#" onclick="window.print(); return false;" class="btn atch"><i class="fas fa-print"></i> 印刷する</a>
</div>
</div>
</section>
