...
<li id="back" class="no-sp"><a href="/unproducts" class="disp_f">カテゴリトップに戻る</a></li>
...
<li class="text_c">
<a href="/un-contact?goods_title=<?php the_title();?>&goods_code=<?php the_field('code');?>" class="disp_f">お問い合わせ</a>
</li>
</ul>
</nav>
</div>
...
<dd class="product_detail_content"><?php the_field('m2'); ?>坪</dd>
</dl>
</div>
</div>
...
<dt class="product_detail_title box">メーカー型式</dt>
...
<a href="#" onclick="window.print(); return false;" class="btn unit"><i class="fas fa-print"></i> 印刷する</a>
</div>
</div>
</section>
