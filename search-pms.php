...
<div class="hits flex strong_f">[<?php echo get_search_query(); ?>]での検索結果: <span class="num"><?php echo $wp_query->found_posts; ?></span>  件 ヒットしました<span class="more unit"><a href="/pm-search"><i class="fas fa-filter"></i>絞り込む</a></span></div>
